...
require (
	...
	k8c.io/kubermatic v8.88.1+incompatible
	k8c.io/kubermatic/v2 v2.19.1-0.20220613150948-4e2fb5e3080c
	k8s.io/api v0.24.0
...
require (
	...
	github.com/kubermatic/kubermatic v8.88.1+incompatible // indirect
