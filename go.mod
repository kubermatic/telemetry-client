...
require (
	...
	k8c.io/kubermatic/v2 v2.19.1-0.20220613150948-4e2fb5e3080c // kubermaticconfiguration.status is not released yet, hence importing @latestcommit
	k8s.io/api v0.24.0
...
require (
	...
	github.com/kubermatic/machine-controller v1.51.0 // indirect
	...
	kubevirt.io/api v0.53.0 // indirect
